...
<title>Spring3 Annotations MySQL Login</title>
...
<body>
	...
	<form:form action="login" commandName="loginForm" method="post">
		<table align="center">
			...
			<tr>
				<td class="right"><input type="submit" value="Submit" id="loginButton" onclick="return validateData();"/></td>
				<td class="left"> </td>
			</tr>
		</table>
	</form:form>
